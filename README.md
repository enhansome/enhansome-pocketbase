...
* [Golang Server](https://github.com/pocketbase/pocketbase/releases/) ⭐ 61,144 | 🐛 19 | 🌐 Go | 📅 2026-09-21 - The main PocketBase server. ![GitHub Repo stars](https://img.shields.io/github/stars/pocketbase/pocketbase)
...
* [SvelteKit PocketBase Auth](https://github.com/jianyuan/pocketbase-sveltekit-auth) ⭐ 235 | 🐛 15 | 🌐 Svelte | 📅 2026-09-23 - Demo login and registration pages with examples. ![GitHub Repo stars](https://img.shields.io/github/stars/jianyuan/pocketbase-sveltekit-auth)
...
* [Next.js PocketBase Auth](https://github.com/jianyuan/pocketbase-nextjs-auth) ⭐ 24 | 🐛 11 | 🌐 TypeScript | 📅 2026-09-23 - Sample Next.js 15 application with PocketBase integration, a typed client, server-side and client-side rendering techniques, and server actions. ![GitHub Repo stars](https://img.shields.io/github/stars/jianyuan/pocketbase-nextjs-auth)
...
* [DigitalOcean](https://github.com/pocketbase/pocketbase/discussions/512) ⭐ 61,144 | 🐛 19 | 🌐 Go | 📅 2026-09-21 - Guide to deploy in a Droplet.
* [Fly.io](https://github.com/pocketbase/pocketbase/discussions/537) ⭐ 61,144 | 🐛 19 | 🌐 Go | 📅 2026-09-21 - Guide to deploy for free in Fly.io.
...
* [Marmot](https://github.com/maxpert/marmot) ⭐ 2,821 | 🐛 16 | 🌐 Go | 📅 2026-09-15 - A distributed SQLite replicator [with PocketBase tutorial](https://www.youtube.com/watch?v=Zapupe_FREc). ![GitHub Repo stars](https://img.shields.io/github/stars/maxpert/marmot)
...
| [marked](https://github.com/markedjs/marked) ⭐ 37,203 \| 🐛 18 \| 🌐 TypeScript \| 📅 2026-09-22 | works without changes                                                                                          | A markdown parser and compiler. Built for speed. | ![GitHub Repo stars](https://img.shields.io/github/stars/markedjs/marked)            |
