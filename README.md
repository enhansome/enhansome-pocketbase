...
* [Golang Server](https://github.com/pocketbase/pocketbase/releases/) ⭐ 61,151 | 🐛 19 | 🌐 Go | 📅 2026-09-21 - The main PocketBase server. ![GitHub Repo stars](https://img.shields.io/github/stars/pocketbase/pocketbase)
...
* [Proxy](https://github.com/iamelevich/pocketbase-plugin-proxy) ⭐ 23 | 🐛 2 | 🌐 Go | 📅 2026-09-25 - Forward requests to another host. Can be useful when you want to use separate server as frontend (like Next.js), but serve everything with same port. ![GitHub Repo stars](https://img.shields.io/github/stars/iamelevich/pocketbase-plugin-proxy)
...
* [DigitalOcean](https://github.com/pocketbase/pocketbase/discussions/512) ⭐ 61,151 | 🐛 19 | 🌐 Go | 📅 2026-09-21 - Guide to deploy in a Droplet.
* [Fly.io](https://github.com/pocketbase/pocketbase/discussions/537) ⭐ 61,151 | 🐛 19 | 🌐 Go | 📅 2026-09-21 - Guide to deploy for free in Fly.io.
...
| [marked](https://github.com/markedjs/marked) ⭐ 37,207 \| 🐛 18 \| 🌐 TypeScript \| 📅 2026-09-22 | works without changes                                                                                          | A markdown parser and compiler. Built for speed. | ![GitHub Repo stars](https://img.shields.io/github/stars/markedjs/marked)            |
